...
class BaseProject(BaseModule):
    def _init_attr(
        ...
        # add new predefined subdir here
        self.project_name = project_config.project_name
        self.project_meta_path = project_config.project_meta_path
    ...
    def launch(
        ...
        launched_time = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
        ...
        if not os.path.exists(os.path.join(self.project_root, self.project_meta_path)):
            os.makedirs(os.path.join(self.project_root, self.project_meta_path)) 
        ...
        new_project_info = {
            ...
            'meta_path': self.project_meta_path,
            ...
            'last_launched_time': launched_time,
        }
        ...
        if os.path.exists(os.path.join(self.project_root, self.project_info_path)):
            ...
            project_info.update(new_project_info)
        else:
            new_project_info['created_time'] = launched_time
        ...
        save_object(project_info, self.project_info_path, 'meta')

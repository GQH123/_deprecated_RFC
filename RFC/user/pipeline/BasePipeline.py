...
class Pipeline(BaseModule):
    ...
    def _init_project(
        ...
        def get_project_config():
            ...
            project_type = user_project_config.pop('type', 'project')
    ...
    def _init_itemset(
        ...
        def get_itemset_config():
            ...
            itemset_type = user_itemset_config.pop('type', 'rawitemset')
    ...
    def _init_requestor(
        ...
        def get_arguments_config():
            ...
            arguments_type = user_arguments_config.pop('type', 'arguments-noproxy')
        ...
        def get_middleware_config():
            ...
            for middleware_config in user_middleware_config:
                middleware_type = middleware_config.pop('type', 'json')
                ...
                middleware_config = get_config(middleware_type)
                middleware_config = middleware_config(**middleware_config)
                middleware_configs.append(middleware_config)
            if self.verbose:
                self.logger('middleware config:\n')
                middleware_configs.print(include_sub=False)
    ...
    def _init_all(
        ...
        self._init_requestor(pipeline_config.requestor_name, pipeline_config.user_arguments_config, pipeline_config.user_session_config, pipeline_config.user_middleware_config)

...
SUPPORTED_PROJECT_TYPES = [x for x in os.listdir(os.path.join(os.path.dirname(__file__), 'types')) if x not in ['__pycache__', '__init__.py']]
...
def create_dirs(project_path, project_type='default'):
    try:

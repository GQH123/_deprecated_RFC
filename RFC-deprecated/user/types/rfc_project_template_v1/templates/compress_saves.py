...
import traceback
from crawler_xxx import ItemTypeName1, ItemTypeName2, ...  # you should import all your defined ItemTypes here
            ...
            try:
                ...
                if is_textfile(filepath):
                    ...
                    try:
                        ...
                        print(f'warning: {filepath} failed to read as text, will treat as binary, {e}', flush=True)
                    else:
                ...
                if True:
                    ...
                    if os.path.exists(filebinpath):
                        print(f'warning: {filebinpath} already exists, {filepath} skipped.', flush=True)
                        continue
                ...
                print(f'failed: {error_report}', flush=True)
    # final save
    if path_pkl_mapping:
        path_pkl_mapping_step += 1
        pickle.dump(path_pkl_mapping, open(os.path.join(pklpath, f'path_pkl_mapping_{path_pkl_mapping_step}.pkl'), 'wb'))
